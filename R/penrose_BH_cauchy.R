penrose_BH_cauchy <- function(colours=standard_colours, ...){
  ...
  ## r_values[3]~=1.278465 is  chosen so the line is exactly vertical
  r_values <- c(1.05,1.15,1+lambert_W0(exp(-1)),1.5,2:5)  
  ...
  ## label the universe and black hole:
  text(0.5,-0.07,"universe")
  text(0.0, 0.32,"black hole")
