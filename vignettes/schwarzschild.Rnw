...
\Keywords{Black holes, general relativity, Schwarzschild metric,
  Eddingon coordinates, Lema\^{i}tre coordinates, Gullstrand
...
\caption[Extended Penrose diagram of the universe with a black hole,
  ...
  interact with rigthward light originating from the antiuniverse in
  the black hole}
\end{center}
\end{figure}
...
Schwarzschild spacetime may be displayed, incuding Schwarzschild
coordinates, Eddingon coordinates, Lema\^{i}tre coordinates,
