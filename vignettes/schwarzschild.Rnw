...
heavily documented in the R programming language and is freely
available under the General Public License.  A variety of coordinate
transforms of Schwarzschild spacetime may be displayed, including
Schwarzschild coordinates, Eddington coordinates, Lema\^{i}tre
coordinates, Gullstrand coordinates, and a number of Penrose
transforms.  Further work might include illustration of the Kerr or
Reissner-Nordstr\"{o}m metrics.
